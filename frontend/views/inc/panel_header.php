  ...
  <div class="panel-main">
    ...
    <div class="panel-top">
      ...
      <div class="panel-top-actions">
        <a href="<?= url('panel/notifications.php') ?>" class="notif-btn <?= pnav('notifs',$active) ?>" title="اعلان‌ها" aria-label="اعلان‌ها">
          <?= icon('bell') ?>
          <?php if ($unreadNotifs > 0): ?><span class="notif-dot"><?= fa_num($unreadNotifs) ?></span><?php endif; ?>
        </a>
